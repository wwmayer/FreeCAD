...
PyObject* SelectionPy::createModule()
{
    ...
    return PyModule_Create(&SelectionModuleDef);
}

// SelectionPy Methods  // Methods structure
PyMethodDef SelectionPy::Methods[] = {
    {"addSelection",         (PyCFunction) SelectionPy::sAddSelection, METH_VARARGS,
     ...
     "clear : bool\n    Clear preselection."},
    {"updateSelection",      (PyCFunction) SelectionPy::sUpdateSelection, METH_VARARGS,
    ...
    {"removeSelection",      (PyCFunction) SelectionPy::sRemoveSelection, METH_VARARGS,
    ...
    {"clearSelection"  ,     (PyCFunction) SelectionPy::sClearSelection, METH_VARARGS,
     ...
     "docName : str\n    Name of the `App.Document`.\n"
     "clearPreSelect : bool\n    Clear preselection."},
    {"isSelected",           (PyCFunction) SelectionPy::sIsSelected, METH_VARARGS,
    ...
    {"setPreselection",      reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) ()>( SelectionPy::sSetPreselection )), METH_VARARGS|METH_KEYWORDS,
     ...
     "type : int"},
    {"getPreselection",      (PyCFunction) SelectionPy::sGetPreselection, METH_VARARGS,
    "getPreselection() -> Gui.SelectionObject\n"
    "\n"
    "Get preselected object."},
    {"clearPreselection",   (PyCFunction) SelectionPy::sRemPreselection, METH_VARARGS,
     "clearPreselection() -> None\n"
     "\n"
     "Clear the preselection."},
    {"countObjectsOfType",   (PyCFunction) SelectionPy::sCountObjectsOfType, METH_VARARGS,
     ...
     "docName : str\n    Name of the `App.Document`.\n"
     "resolve : int"},
    {"getSelection",         (PyCFunction) SelectionPy::sGetSelection, METH_VARARGS,
    ...
    {"getPickedList",         (PyCFunction) SelectionPy::sGetPickedList, 1,
     ...
     "\n"
     "docName : str\n    Name of the `App.Document`."},
    {"enablePickedList",      (PyCFunction) SelectionPy::sEnablePickedList, METH_VARARGS,
     "enablePickedList(enable=True) -> None\n"
     "\n"
     "Enable/disable pick list.\n"
     "\n"
     "enable : bool"},
    {"getCompleteSelection", (PyCFunction) SelectionPy::sGetCompleteSelection, METH_VARARGS,
     "getCompleteSelection(resolve=ResolveMode.OldStyleElement) -> list\n"
     "\n"
     "Return a list of selected objects across all documents.\n"
     "\n"
     "resolve : int"},
    {"getSelectionEx",         (PyCFunction) SelectionPy::sGetSelectionEx, METH_VARARGS,
     ...
     "    0: do not resolve, 1: resolve, 2: resolve with element map.\n"
     "single : bool\n    Only return if there is only one selection."},
    {"getSelectionObject",  (PyCFunction) SelectionPy::sGetSelectionObject, METH_VARARGS,
    ...
    {"setSelectionStyle",         (PyCFunction) SelectionPy::sSetSelectionStyle, METH_VARARGS,
     "setSelectionStyle(selectionStyle) -> None\n"
     "\n"
     "Change the selection style. 0 for normal selection, 1 for greedy selection\n"
     "\n"
     "selectionStyle : int"},
    {"addObserver",         (PyCFunction) SelectionPy::sAddSelObserver, METH_VARARGS,
     ...
     "resolve : int"},
    {"removeObserver",      (PyCFunction) SelectionPy::sRemSelObserver, METH_VARARGS,
     "removeObserver(object) -> None\n"
     "\n"
     "Uninstall an observer.\n"
     "\n"
     "object : object\n    Python object instance."},
    {"addSelectionGate",      (PyCFunction) SelectionPy::sAddSelectionGate, METH_VARARGS,
    ...
    {"removeSelectionGate",      (PyCFunction) SelectionPy::sRemoveSelectionGate, METH_VARARGS,
     "removeSelectionGate() -> None\n"
     "\n"
     "Remove the active selection gate."},
    {"setVisible",            (PyCFunction) SelectionPy::sSetVisible, METH_VARARGS,
     "setVisible(visible=None) -> None\n"
     "\n"
     "Set visibility of all selection items.\n"
     "\n"
     "visible : bool, None\n    If None, then toggle visibility."},
    {"pushSelStack",      (PyCFunction) SelectionPy::sPushSelStack, METH_VARARGS,
    ...
    {"hasSelection",      (PyCFunction) SelectionPy::sHasSelection, METH_VARARGS,
     ...
     "docName : str\n    Name of the `App.Document`.\n"
     "resolve : int"},
    {"hasSubSelection",   (PyCFunction) SelectionPy::sHasSubSelection, METH_VARARGS,
     ...
     "docName : str\n    Name of the `App.Document`.\n"
     "subElement : bool"},
    {"getSelectionFromStack",(PyCFunction) SelectionPy::sGetSelectionFromStack, METH_VARARGS,
...
PyObject *SelectionPy::sAddSelection(PyObject * /*self*/, PyObject *args)
{
...
PyObject *SelectionPy::sUpdateSelection(PyObject * /*self*/, PyObject *args)
{
    PyObject *show;
    PyObject *object;
    char* subname=nullptr;
...
PyObject *SelectionPy::sRemoveSelection(PyObject * /*self*/, PyObject *args)
{
    SelectionLogDisabler disabler(true);
...
PyObject *SelectionPy::sClearSelection(PyObject * /*self*/, PyObject *args)
{
    SelectionLogDisabler disabler(true);
    PyObject *clearPreSelect = Py_True;
...
PyObject *SelectionPy::sIsSelected(PyObject * /*self*/, PyObject *args)
{
    PyObject *object;
    char* subname = nullptr;
    int resolve = 1;
...
PyObject *SelectionPy::sCountObjectsOfType(PyObject * /*self*/, PyObject *args)
{
    char* objecttype;
...
PyObject *SelectionPy::sGetSelection(PyObject * /*self*/, PyObject *args)
{
    char *documentName = nullptr;
    int resolve = 1;
...
PyObject *SelectionPy::sEnablePickedList(PyObject * /*self*/, PyObject *args)
{
...
PyObject *SelectionPy::sSetPreselection(PyObject * /*self*/, PyObject *args, PyObject *kwd)
{
    PyObject *object;
...
PyObject *SelectionPy::sGetPreselection(PyObject * /*self*/, PyObject *args)
{
...
PyObject *SelectionPy::sRemPreselection(PyObject * /*self*/, PyObject *args)
{
    if (!PyArg_ParseTuple(args, ""))
        return nullptr;
...
PyObject *SelectionPy::sGetCompleteSelection(PyObject * /*self*/, PyObject *args)
{
    int resolve = 1;
...
PyObject *SelectionPy::sGetSelectionEx(PyObject * /*self*/, PyObject *args)
{
    char *documentName = nullptr;
    int resolve = 1;
    PyObject *single = Py_False;
...
PyObject *SelectionPy::sGetPickedList(PyObject * /*self*/, PyObject *args)
{
    char *documentName = nullptr;
...
PyObject *SelectionPy::sGetSelectionObject(PyObject * /*self*/, PyObject *args)
{
...
PyObject *SelectionPy::sSetSelectionStyle(PyObject * /*self*/, PyObject *args)
{
    int selStyle = 0;
    ...
    PY_TRY {
        Selection().setSelectionStyle(selStyle == 0 ? SelectionSingleton::SelectionStyle::NormalSelection
...
PyObject *SelectionPy::sAddSelObserver(PyObject * /*self*/, PyObject *args)
{
    PyObject* o;
    int resolve = 1;
...
PyObject *SelectionPy::sRemSelObserver(PyObject * /*self*/, PyObject *args)
{
    PyObject* o;
...
PyObject *SelectionPy::sAddSelectionGate(PyObject * /*self*/, PyObject *args)
{
    char* filter;
    int resolve = 1;
    ...
    if (PyArg_ParseTuple(args, "O!|i",SelectionFilterPy::type_object(),&filterPy,resolve)) {
        PY_TRY {
            Selection().addSelectionGate(new SelectionFilterGatePython(filterPy), toEnum(resolve));
            Py_Return;
        }
        PY_CATCH;
    }
...
PyObject *SelectionPy::sRemoveSelectionGate(PyObject * /*self*/, PyObject *args)
{
    if (!PyArg_ParseTuple(args, ""))
        return nullptr;
...
PyObject *SelectionPy::sSetVisible(PyObject * /*self*/, PyObject *args)
{
    ...
    PY_TRY {
        SelectionSingleton::VisibleState vis = SelectionSingleton::VisToggle;
...
PyObject *SelectionPy::sPushSelStack(PyObject * /*self*/, PyObject *args)
{
...
PyObject *SelectionPy::sHasSelection(PyObject * /*self*/, PyObject *args)
{
...
PyObject *SelectionPy::sHasSubSelection(PyObject * /*self*/, PyObject *args)
{
    const char *doc = nullptr;
...
PyObject *SelectionPy::sGetSelectionFromStack(PyObject * /*self*/, PyObject *args)
{
    char *documentName = nullptr;
    int resolve = 1;
    int index = 0;

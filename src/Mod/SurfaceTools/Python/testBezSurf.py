...
bs1a = Draft.makeBezCurve(p1a,closed=False,support=None)
bs2a = Draft.makeBezCurve(p2a,closed=False,support=None)

bs1b = Draft.makeBezCurve(p1b,closed=False,support=None)
bs2b = Draft.makeBezCurve(p2b,closed=False,support=None)
bs3b = Draft.makeBezCurve(p3b,closed=False,support=None)

bs1c = Draft.makeBezCurve(p1c,closed=False,support=None)
bs2c = Draft.makeBezCurve(p2c,closed=False,support=None)
bs3c = Draft.makeBezCurve(p3c,closed=False,support=None)
bs4c = Draft.makeBezCurve(p4c,closed=False,support=None)

mydoc.recompute()

### Add Test Feature Two sides ###

test1 = mydoc.addObject('SurfaceTools::BezSurf', 'two_curves')

### Add Bezier Curves to test ###

#mydoc.test.Border = [(bs1, 'Edge1'), (bw2, 'Edge1'), (bw3, 'Edge1'), (bs4, 'Edge1')]
test1.aBezList = [(bs1a, 'Edge1'), (bs2a, 'Edge1')]
...
#mydoc.test.Border = [(bs1, 'Edge1'), (bw2, 'Edge1'), (bw3, 'Edge1'), (bs4, 'Edge1')]
test2.aBezList = [(bs1b, 'Edge1'), (bs2b, 'Edge1'), (bs3b, 'Edge1')]
...
test3 = mydoc.addObject('SurfaceTools::BezSurf', 'four_curves')

### Add Bezier Curves to test ###

#mydoc.test.Border = [(bs1, 'Edge1'), (bw2, 'Edge1'), (bw3, 'Edge1'), (bs4, 'Edge1')]
test3.aBezList = [(bs1c, 'Edge1'), (bs2c, 'Edge1'), (bs3c, 'Edge1'), (bs4c, 'Edge1')]

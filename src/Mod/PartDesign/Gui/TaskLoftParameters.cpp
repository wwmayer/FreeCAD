...

{
    ...
    connectModObject = App::GetApplication().signalChangedObject.connect(
            boost::bind(&TaskLoftWireOrders::slotChangedObjectProperty, this, bp::_1, bp::_2));
...
void TaskLoftWireOrders::slotChangedObjectProperty(const App::DocumentObject&, const App::Property& prop)
{

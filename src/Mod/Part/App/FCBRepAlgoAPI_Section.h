...
public:
    ...
    //! Obsolete
    Standard_EXPORT FCBRepAlgoAPI_Section(const TopoDS_Shape& S1, const TopoDS_Shape& S2, const bool PerformNow = true);
    ...
    //! if <PerformNow>=True - the algorithm is performed immediately
    //! Obsolete
    Standard_EXPORT FCBRepAlgoAPI_Section(const TopoDS_Shape& S1, const gp_Pln& Pl, const bool PerformNow = true);
